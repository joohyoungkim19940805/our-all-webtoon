...
public abstract non-sealed class BirdPlusException extends RuntimeException
        implements CommonExceptionResult {
    /**
     * 
     */
    ...
    public enum Result
            implements com.our.all.webtoon.util.exception.CommonExceptionResult.CommonResultCode {
        ...
        private Result(int code, String message, String summary, String redirectUrl) {
            this.code = code;
