import FreeWillEditor from '../FreeWillEditor.js';
...
export default class UndoManager {
    ...
    rememberCursor() {
        ...
        let newRect = range.getBoundingClientRect();
        if (
            this.#lastCursorPositionRect &&
            this.#lastCursorPositionRect.x == newRect.x &&
            this.#lastCursorPositionRect.y == newRect.y
        ) {
            return;
        }
