...
export default class Resources extends FreedomInterface {
    ...
    constructor(dataset) {
        ...
        if (!dataset && Object.keys(this.dataset).length == 0) {
            ...
            Resources.customResourcesCallback &&
            typeof Resources.customResourcesCallback == 'function'
        ) {
    ...
    createDefaultContent() {
        return new Promise((resolve) => {
            ...
            let resourcesContanier = Object.assign(
            ...
            this.resources.onload = (event) => {
                ...
                if (!this.resources.contentWindow) {
                    ...
                    this.resources.contentWindow.document.body.style.contentVisibility =
                        'auto';
                    this.resources.contentWindow.document.body.style.containIntrinsicSize =
                        '1px 5000px';
                }
            ...
            let previewButton = Object.assign(
                document.createElement('button'),
                {
    ...
    createDescription(resources, resourcesContanier) {
        ...
        description.onclick = (event) => {
            ...
            if (description.dataset.open_status == '▼') {
                description.dataset.open_status = '▶';
                resourcesContanier.style.height =
                    window.getComputedStyle(resources).height;
                setTimeout(() => {
