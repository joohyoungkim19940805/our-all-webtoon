...
import FontFamilyBox from '../component/FontFamilyBox.js';
...
export default class FontFamily extends FreedomInterface {
    ...
    static {
            ...
            if (
                ...
                this.fontFamilyBox.open().then((fontFamilyBoxContainer) => {
                    super.processingElementPosition(
                        this.fontFamilyBox.fontFamilyBox,
        ...
        super.outClickElementListener(
            ...
            ({ oldEvent, newEvent, isMouseOut }) => {
                if (
                    isMouseOut &&
                    this.fontFamilyBox.fontFamilyBox.isConnected &&
    ...
    constructor(dataset) {
        ...
        if (!dataset && Object.entries(this.dataset).length == 0) {
            this.dataset.font_family =
                FontFamily.fontFamilyBox.selectedFont?.style.fontFamily;
        }
